...
import handImg from '../Assets/rekhaedit.png'
import rekha from '../Assets/rekhaa.jpeg'
import backImageBlack from '../Assets/body-bg-free-img.jpg'
import nc1 from '../Assets/jw1.webp'
import nc2 from '../Assets/jw2.webp'
import nc3 from '../Assets/jw4.jpg'
import nc4 from '../Assets/jw5.webp'
import "react-responsive-carousel/lib/styles/carousel.min.css"; 
import { Carousel } from 'react-responsive-carousel';
import carousal1img from '../Assets/video slider/photo-1531995811006-35cb42e1a022.jpg'
import carousal2img from '../Assets/cara1.jpeg'
import carousal3img from '../Assets/cara2.jpeg'
import carousal4img from '../Assets/cara4.jpeg'
import carousal5img from '../Assets/cara3.jpeg'
...
import ringimg from '../Assets/earrings.jpeg'
import neckpiece from '../Assets/neck.jpeg'
import bracelet from '../Assets/jwll.jpeg'
import earring from '../Assets/rings.jpeg'
  ...
  return (
    ...
    <Box m="30px">
      ...
      <Box textAlign={"left"}  color={"#171616"} fontWeight={"400"}>
        ...
        <Text fontSize={"16px"}>Check Out the New Collections</Text>
      </Box>
      <Box>
     ...
     <Grid  textAlign={"left"} color={"#171616"} w="90%" m="20px auto" gap="10px" templateColumns={{base:"repeat(1,1fr)" , sm : "repeat(1,1fr)" , md : "repeat(2,1fr)" , lg : "repeat(3,1fr)" , xl : "repeat(3,1fr)" , "2xl" : "repeat(4,1fr)"}}>
      ...
      <Box  boxShadow= "rgba(149, 157, 165, 0.2) 0px 8px 24px">
        <Image src={nc4} />
        <Heading m="10px" as="h6" size={"sm"}>Choker</Heading>
     ...
     <Box  w="90%" m="70px auto" >
      ...
      <Box mt="80px" textAlign={"left"}  color={"#171616"} fontWeight={"400"}>
        <Heading size={"lg"} fontWeight={"400"} textTransform={"uppercase"}>Bestsellers</Heading>
   ...
   <Box display={{base:"none",sm:"none",md:"block",lg:"block","xl":"block","2xl":"block"}} textAlign={"left"} mt="60px"  >
    ...
    <Flex flexDirection={{base : "column", sm : "column", md :"row", lg : "row" , xl : "row" , "2xl" : "row"}} justifyContent={"space-around"}>
      ...
      <Image w="100%" position={"relative"}  bottom="30px" left="30px"  src={rekha} />
      </Box>
   ...
   <Box display={{base:"none",sm:"none",md:"block",lg:"block","xl":"block","2xl":"block"}} textAlign={"left"} mt="30px"  >
    ...
    <Box mt="20px" w={{base:"90%",sm:"90%",md:"60%",lg:"60%",xl:"48%","2xl":"48%"}} p="10px">
        ...
        <Text display={{base:"none",sm:"none",md:"none",lg:"block","xl":"block","2xl":"block"}}></Text>
        <Box mt="20px" w="48%" display={{base:"none",sm:"none",md:"none",lg:"block","xl":"block","2xl":"block"}}>
        <Box mt="20px">
          <Text>"Ananta" was born from a desire to merge the grandeur of Indian jewellery with a commitment to preserving the earth. Our journey begins with the finest artisans who meticulously handcraft each piece, infusing it with the legacy of centuries-old techniques. We source ethical gemstones and use recycled precious metals, reducing our carbon footprint. Our goal is to adorn you with exquisite jewellery that tells a story of sustainability, heritage, and elegance.</Text>
        </Box>
